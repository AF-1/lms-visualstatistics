...
If you find this plugin useful, please consider giving it a <img src="screenshots/githubstar.png" width="20" height="20" margin-top="24px" alt="star" /> on GitHub (top right of this page) so that other users can discover it (in their News Feed).
<br><br>
